...
const researchAgenda = `<b>My research interests center around security and privacy, with a specialized focus on Blockchain, Distributed Systems, Zero-Knowledge Proofs, and Post-Quantum Cryptography. I aim to explore the intersection of these fields to develop innovative solutions that enhance the security and resilience of decentralized systems in the post-quantum era.</b>`;
